                ...
                <div id="collapseOne" class="panel-collapse collapse">
                    <div class="panel-body">
                        <ul class="sliderbar-list-style">
                            <a href="/crhms/pages/admin/account.jsp">
                    ...
                    <div class="panel-body">
                        <ul class="sliderbar-list-style">
                            <a href="/crhms/admin/findAllCommunityAdmin.do">
                                <li><i class="fa fa-circle-o"></i>查看社区健康管理员</li>
                            </a>
                            <a href="/crhms/pages/admin/add-community-admin.jsp">
                                <li><i class="fa fa-circle-o"></i>添加社区健康管理员</li>
                            </a>
                        </ul>
                    </div>
                </div>
