                    ...
                    <div class="main-content">
                        ...
                        <div>
                            ...
                            <div class="alert alert-warning" role="alert">
                                ...
                                <span style="color:#00bf6f;font-size: 24px;font-weight: bolder">(总分: 60)</span>
                            </div>
                            <img style="height: auto;width: 100%"
                                 src="../../img/other/faedab64034f78f0f6d54a8f69310a55b2191ceb.png">
                            <form action="/crhms/healthAssess/assess.do" method="post">
                                <c:forEach items="${healthQuestionnaireList}" var="healthQuestionnaireItem"
                                           varStatus="healthQuestionnaireStatus">
                                    <div class="panel panel-info">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">${healthQuestionnaireItem.title}</h3>
                                        </div>
                                        <div class="panel-body">
                                            <div class="radio">
                                                <label>
                                                    <input type="radio"
                                                           name="healthAssessList[${healthQuestionnaireStatus.index}].score"
                                                           value="4" checked>A、${healthQuestionnaireItem.option_a}
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio"
                                                           name="healthAssessList[${healthQuestionnaireStatus.index}].score"
                                                           value="3">B、${healthQuestionnaireItem.option_b}
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio"
                                                           name="healthAssessList[${healthQuestionnaireStatus.index}].score"
                                                           value="2">C、${healthQuestionnaireItem.option_c}
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio"
                                                           name="healthAssessList[${healthQuestionnaireStatus.index}].score"
                                                           value="1">D、${healthQuestionnaireItem.option_d}
                                                </label>
                                            </div>
                                        </div>
                                    </div>
