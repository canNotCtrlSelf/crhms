                ...
                <div class="col-xs-10">
                    <div class="main-content">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>健康服务</li>
                            <li><a href="/crhms/mentalityQuestionnaire/getQuestionnaire.do">心理评估</a></li>
                            <li>心理评估结果</li>
                        </ol>
                        <!-- 路径导航 /-->
                        <%--评估结果--%>
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">
                                    <span style="color:#00bf6f;font-size: 20px;font-weight: bolder">
                                        ${sessionScope.mentalityAssessResult.totalScore}
                                    </span>
                                </li>

                                <li class="list-group-item active">评价与建议</li>
                                <li class="list-group-item">
                                    测试结果: ${sessionScope.mentalityAssessResult.comments}</li>
                                <li class="list-group-item">
                                    建议: ${sessionScope.mentalityAssessResult.suggestions}</li>
                            </ul>
                        </div>
                        <%-- 评估结果 /--%>
                    </div>
